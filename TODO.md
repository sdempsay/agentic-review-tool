...
| 13 | **Review** — wire classified rules into LLM prompt | pending | **Next task** — connect Classify → Review |
| 14 | **Review** — per-ruleset specialized sub-agents | pending | PRD calls for Java formatting + style agents |
